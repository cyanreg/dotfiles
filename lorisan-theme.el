...
;      (grey-lighter "#e1e2e5")
  ...
  (custom-theme-set-faces
   ...
   `(tab-bar ((,class (:background ,background :foreground ,indigo-dark))))
   `(tab-bar-tab ((,class (:background unspecified :foreground ,indigo-light))))
   `(tab-bar-tab-inactive ((,class (:background unspecified :foreground ,indigo-dark))))
